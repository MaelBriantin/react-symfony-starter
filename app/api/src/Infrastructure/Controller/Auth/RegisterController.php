...
use App\Infrastructure\Response\Auth\SuccessRegisterResponse;
...
class RegisterController extends AbstractController
{
    ...
    public function __invoke(Request $request): SuccessRegisterResponse
    {
        ...
        return new SuccessRegisterResponse($user);
    }
}
